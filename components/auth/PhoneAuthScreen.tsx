                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative" ref={dropdownRef}>
                      ...
                      {isDropdownOpen && (
                        <div className="absolute left-0 top-16 z-50 flex max-h-[22rem] w-72 flex-col rounded-xl bg-white py-2 shadow-2xl border border-slate-200 overflow-hidden">
                              ...
                              filteredCountries.map((country) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <span className="w-10 shrink-0">+{getCountryCallingCode(country)}</span>
                                    <span className="ml-auto text-xs font-medium text-slate-500 truncate">{countryName}</span>
                                  </button>
                                );
                              })
                            ) : (
