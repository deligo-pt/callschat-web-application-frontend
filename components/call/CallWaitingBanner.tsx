...
export const CallWaitingBanner = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[200] w-[95vw] max-w-[480px] animate-in slide-in-from-top-6 duration-300 pointer-events-auto">
      <div className="relative overflow-hidden rounded-3xl bg-[#1D2A54]/95 border border-white/20 p-4 shadow-[0_12px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl flex items-center justify-between gap-3">
        {/* Subtle background glow */}
        <div className="absolute -left-10 -top-10 w-32 h-32 bg-[#3B58F5] opacity-30 blur-[40px] rounded-full pointer-events-none" />
        ...
        <div className="flex items-center gap-3 min-w-0 z-10">
          <div className="relative flex-shrink-0">
            ...
            />
            <div className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500 border border-[#1D2A54]">
        ...
        <div className="flex items-center gap-2 z-10 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center justify-center h-10 px-3 rounded-full bg-red-500/20 hover:bg-red-500/30 border border-red-500/40 text-red-300 hover:text-red-200 transition-all text-xs font-semibold gap-1.5 active:scale-95 shadow-sm"
          ...
          <button
            ...
            className="flex items-center justify-center h-10 px-3.5 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white transition-all text-xs font-semibold gap-1.5 shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:scale-105 active:scale-95"
